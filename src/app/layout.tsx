  ...
  return (
    <html lang="de">
      <head>
        ...
        <link href="https://fonts.googleapis.com/css2?family=Bangers&family=Playfair+Display:ital,wght@0,400;0,700;1,400&family=Comic+Neue:wght@400;700&display=swap" rel="stylesheet" />
      </head>
      <body>
        <Toaster
          position="top-center"
