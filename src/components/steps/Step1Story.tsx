    ...
    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="max-w-2xl mx-auto space-y-8">
      ...
      {mode === "frei" && (
        <div className="space-y-3">
          <textarea
            ...
            placeholder="Stichpunkte reichen! z. B.: Toskana, Sommer 2023, Emma 6 Jahre, erster Gelato, verlorener Teddy, Sonnenuntergang."
            rows={10}
      ...
      {mode === "gefuehrt" && (
        <div className="space-y-6">
          ...
          {/* 2. Comic-Stil – direkt nach Kategorie */}
          <AnimatePresence>
            {category && (
              <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0 }} className="space-y-3">
                <label className="text-sm font-semibold text-brand-700">
                  2. Welchen Comic-Stil soll deine Geschichte haben?
                </label>
          ...
          <AnimatePresence>
            {category && (
              <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="space-y-3">
                ...
                <p className="text-xs text-gray-400">Füge so viele Momente hinzu wie du möchtest – jeder bekommt seine eigene Illustration.</p>
                <div className="space-y-3">
